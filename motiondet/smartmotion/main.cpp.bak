...
{
    const string DIR = "/tmp/motion/"; // directory where the images will be stored
    ...
    cvSetCaptureProperty(camera, CV_CAP_PROP_FRAME_WIDTH, 640); // width of viewport of camera
    cvSetCaptureProperty(camera, CV_CAP_PROP_FRAME_HEIGHT, 480); // height of ...
	...
	//imshow("Frame", motion); // Show live results on screen!

        //imshow("Frame", result); // Show live results on screen!
		...
		imshow("Frame", result_cropped); // Show live results on screen!
